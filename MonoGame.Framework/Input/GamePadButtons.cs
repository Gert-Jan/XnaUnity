...
or conditions. You may have additional consumer rights under your local laws which this license cannot change. To the Extensionent
...
namespace Microsoft.Xna.Framework.Input
{
    public struct GamePadButtons
    {
        ...
        public ButtonState Extension0
        {
            get
            {
                return ((buttons & Buttons.Extension0) == Buttons.Extension0) ? ButtonState.Pressed : ButtonState.Released;
            }
        }
        public ButtonState Extension1
        {
            get
            {
                return ((buttons & Buttons.Extension1) == Buttons.Extension1) ? ButtonState.Pressed : ButtonState.Released;
            }
        }
        public ButtonState Extension2
        {
            get
            {
                return ((buttons & Buttons.Extension2) == Buttons.Extension2) ? ButtonState.Pressed : ButtonState.Released;
            }
        }
        public ButtonState Extension3
        {
            get
            {
                return ((buttons & Buttons.Extension3) == Buttons.Extension3) ? ButtonState.Pressed : ButtonState.Released;
            }
        }
        public ButtonState Extension4
        {
            get
            {
                return ((buttons & Buttons.Extension4) == Buttons.Extension4) ? ButtonState.Pressed : ButtonState.Released;
            }
        }
        public ButtonState Extension5
        {
            get
            {
                return ((buttons & Buttons.Extension5) == Buttons.Extension5) ? ButtonState.Pressed : ButtonState.Released;
            }
        }
